            ...
            <div className="row gy-4">
              <div className="col-12">
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  <div>
                    <h5>Email</h5>
                    <p className="mb-0 text-muted text-break">babarbinyamin2001@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  <div>
                    <h5>Linkedin</h5>
                    <p className="mb-0 text-muted text-break">https://www.linkedin.com/m/in/babarbinyamin/</p>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  <div>
                    <h5>GitHub</h5>
                    <p className="mb-0 text-muted v">https://github.com/Babar-Developer-2001</p>
                  </div>
                </div>
              </div>
            </div>
