            ...
            <div className="row align-items-center gy-4">
              <div className="col-md-6 col-12">
                <img
                  ...
                  className="img-fluid aboutSectionBottom w-100 object-fit-cover rounded-4 shadow-sm "
                  alt="stats count"
                />
              </div>
              <div className="col-md-6 col-12 ps-md-4 mt-sm-5">
                ...
                <p className="text-muted my-4">
                  ...
                  ensure their digital transformation is positioned for
                  long-term success.”
                </p>
                <div className="d-flex  align-items-center">
                  ...
                  <div>
                    <h5>Karen Lynn</h5>
                    <p className="mb-0 text-muted">CEO & Co-founder @ Company</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row align-items-center g-4">
              <div className="col-md-6 col-12">
                ...
                <p className="my-4 pb-4 text-muted fs-lg-5">
                  Our mission is to make the world a greener place, one plant at
                  a time. We strive to provide our customers with the highest
                  quality plants and plant care products, along with the
                  knowledge and support to help them thrive.
                </p>
                <div className="row">
              ...
              <div className="col-md-6 col-12">
                <img src="./src/assets/images/our-mission.webp" className="img-fluid w-100 object-fit-cover rounded-4 shadow-sm" alt="our-mission" />
              </div>
            </div>
          </div>
        </div>
